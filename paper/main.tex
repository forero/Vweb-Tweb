...
than 500 particles were kept to get a robust computation for the spin.

However the analysis are reported ona box of $300$\hMpc on a
side. Four different gaussian smoothing scales are used: 

The method to define the filamentary structure is based on the
eigenvalues of the hessian of the density.
