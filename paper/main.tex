...
Author & Web Method & Halo Finder & Spatial Scale & Test Direction &
Alignment & Mass dependence\\\hline
\cite{Hahn2007} & Tidal Web & FOF & $2.1$\hMpc & along
the filament & $-$& none\\
\cite{Hahn2007} & Tidal Web & FOF & $2.1$\hMpc &
perpendicular to sheet & $-$$-$ & stronger $>10^{12}$\hMsun\\
\cite{Hatton2001} & Neighbors$^1$ & FOF & & & 0\\\hline\hline
\end{tabular}\\
...
$11^{11.5}<M_{\rm vir}<12^{12.5}\hMsun$ and $M_{\rm vir}>12^{12.5}\hMsun$.

THe identification of the cosmic web is done on a grid of $256^3$ with
a gaussian smoothing of $\sim 1$\hMpc over the velocity field. The
details of this smoothing are different from ours. This is decribed in
...
The simulation is the millennium simulation, which has $2160^3$
...
spin. For each halo the spin is defined as the sum of the angular momentum
of each particle with respect to the center of mass. 
