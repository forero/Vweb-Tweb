...
as a function of their large scale environment. In these situations the environment
definition is usually based on quantities easily accesible to observations
such as the number density. With the advent
of large
