...
charachterized by the tidal and velocity shear fields. We focus on the
...
presents the strongesalignment along filaments and walls defined by
the tidal field with a signal that gets stronger as the halo mass
increases; in the case of the velocity shear field only massive halos
$>10^{12}$\hMsun tend to have their shapes perpendicular to filaments
and walls. For the angular momentum we find alignment signals only for
halos more massive than $10^{12}$\hMsun both in the tidal and velocity
shear webs where the preferences are to be perpendicular to filaments
or parallel to walls, respectively. Finally, the peculiar velocities
show a strong alignment for all halo masses to move along filaments
and walls in the tidal web, while in the velocity shear the same
alignment is present but weaker and only for halos less massive than
$10^{12}$\hMsun. Most of the different signals between the two web
description are due to the fact that the main directions of stronger
tidal tension and velocity shear coincide for halos below $10^{12}$\hMpc but are
perpendicular to each other for halos more massive than this
threshold.  ur results clearly show that the two different
...
way to understand the effect of the cosmic web on galaxy evolution.
\end{abstract}
\begin{keywords}
...
environment def nition started to be more complex, involving shear
properties of the galaxy density field or the reconstructuted dark
matter density field
\citep[e.g.]{Lee2005,Sousbie2008,MunozCuartas2011,Tempel2014}.  
...
properties ant their place in the web \citep{Ocvirk2008,Dekel2009}.   
...
simmetry properties of the local dark matter distribution. With the
aid of simulations it has been established that halos of a given mass
form earlier in denser regions; concentration, angular momentum and shape also
depend can be aligned with these web elements. \citep[e.g][]{Hahn2007,Sousbie2008b,Tweb,Gonzalez2010,Noh2011}.    

The observational studies that try to measure angular momentum correlations
use the galaxy shape as a proxy  \citep{Lee2002,Lee2007,Jones2010}. In
...
velocities with large scale structure.
...
defines the direction perpendicular to walls, a strong alignemnt along
...
\caption{Fraction of halos in a mass bin that show a preferential
  ...
  random vector field. The uncertainty is computed assumed poissonian
...
\caption{Median of $|\cos\theta|$ quantifying the shape alignment for
  ...
  resolutions as a function of halo mass. In the upper (lower) panels
...
\caption{Median of $|\cos\theta|$ quantifying the angular momentum
  ...
  eivenvector and the angular momentum
...
\caption{Median of $\vert\cos\theta\vert$ quantifying the peculiar velocity
  ...
  grid resolutions as a function of halo mass. In the upper (lower)
  panels the angle $\theta$ is measured between the first (third)
  eivenvector and a halo's peculiar velocity.
...
or $\vec{e}_3$ en the local definition of the cosmic web. The second
...
but differente perspectives. In future work we will explore the
