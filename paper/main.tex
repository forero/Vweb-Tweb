...
\begin{figure}
\includegraphics[width=0.5\textwidth]{../plot2/Mass/Web.ps}
...
\begin{figure*}
\includegraphics[width=0.48\textwidth]{../plot2/Mass/VWeb.ps}
\includegraphics[width=0.48\textwidth]{../plot2/Mass/TWeb.ps}
\includegraphics[width=0.48\textwidth]{../plot2/Mass/VWebV2.ps}
\includegraphics[width=0.48\textwidth]{../plot2/Mass/TWebV2.ps}
...
\begin{figure*}
\includegraphics[width=0.48\textwidth]{../plot2/Mass/jVWeb.ps}
\includegraphics[width=0.48\textwidth]{../plot2/Mass/jTWeb.ps}
\includegraphics[width=0.48\textwidth]{../plot2/Mass/jVWebV2.ps}
\includegraphics[width=0.48\textwidth]{../plot2/Mass/jTWebV2.ps}
...
\begin{figure*}
\includegraphics[width=0.48\textwidth]{../plot2/Mass/vVWeb.ps}
\includegraphics[width=0.48\textwidth]{../plot2/Mass/vTWeb.ps}
\includegraphics[width=0.48\textwidth]{../plot2/Mass/vVWebV2.ps}
\includegraphics[width=0.48\textwidth]{../plot2/Mass/vTWebV2.ps}
\caption{Median of $\cos\theta$ quantifying the peculiar velocity
  ...
  grid resolutions. In the upper (lower)  panels the angle $\theta$ is
  measured between the first (third) eivenvector and the peculiar
  velocity of each halo.} 
\end{figure*}
...
\subsection{Mass dependency and other conditions for stronger alignment}
