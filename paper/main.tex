...
aligmnent of dark matter haloe with respect to the cosmic web.
...
shape and angular momentum alignment. The Appendix includes a detailed
description of each one the algorithms. 

The main summary from these results can be done in three points. (i)
The halo mass of $1-5\times 10^{12}$\hMsun is a threshold mass between
different behaviours.  (ii) Halo shape is strongly aligned along
filaments, more so for massive haloes and (iii) Halo spin tends to be
perpendicular with respect to filaments, but it is a weak. 
