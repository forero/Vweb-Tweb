...
\item 
\citep{Codis2012}
Studies the alignment of the sping of dark matter halos realtive to
...
eigenvectors. With repecto to the first eigenvector $e_{1}$ there is
antialignement for masses $M>10^{12}$\Msun and alignment for masses
$<10^{12}$\Msun 
