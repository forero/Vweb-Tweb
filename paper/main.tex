...
Studies shape and angular momentum alignments with the cosmic web
defined by the velocity shear tensor method described in this
paper. 

\cite{Libeskind2013} also used the Bolshoi simulation and the halo
...
The aligmnet signal for the angular momentum is very weak while the shape alignment
...
and lies on the plane that define a sheet. The angular momentum is
