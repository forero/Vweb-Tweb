...
alignment along the third eigenvector $\hat{e}_{3}$ of the Tweb for
...
two $\hat{e}_1$ eigenvectors in the Tweb and the Vweb.  The Figure
...
in our measurements. Actually \cite{AragonCalvo2014} confirms the mass
$10^{12}$\hMsun as a transitional scale between alignment
/anti-alignment in filaments, showing that it reflects the degree of
evolution of the host filament.
